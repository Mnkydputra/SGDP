...
=======
                ...
                <a class="navbar-expand-md nostyle text-center" href="#"><i class='bx bxs-inbox bx-sm'></i><br>
                    <p id="navbot" class="text-center">Anggota</p>
                </a>
                <a class="navbar-expand-md nostyle text-center" href="<?= base_url('Anggota/') ?>Course"><i class='bx bxs-food-menu bx-sm'></i><br>
                    <p id="navbot" class="text-center">Course</p>
                </a>
...
<<<<<<< HEAD
                    <div class="container-fluid">
                        <a class="navbar-expand-md nostyle text-center" href="<?= base_url('#/')?>"><i class='bx bxs-home-heart bx-sm'></i><br><p id="navbot" class="text-center">Home</p></a>
                        <a class="navbar-expand-md nostyle text-center" href="<?= base_url('#/')?>"><i class='bx bxs-inbox bx-sm'></i><br><p id="navbot" class="text-center">Inbox</p></a>
                        <a style="margin-top:-30px;" class="navbar-expand-md nostyle text-center" href="<?= base_url('Absen')?>"><i class='bx bx-qr-scan bx-md'></i><br><p id="navbot" class="text-center">Absen</p></a>
                        <a class="navbar-expand-md nostyle text-center" href="<?= base_url('#/')?>"><i class='bx bxs-food-menu bx-sm'></i><br><p id="navbot" class="text-center">Course</p> </a>
                        <a class="navbar-expand-md nostyle text-center" href="<?= base_url('#/')?>"><i class='bx bxs-user bx-sm'></i><br><p id="navbot" class="text-center">Profile</p></a>
                    </div>
                    </nav>
                </div>
        <?php } ?>
