    ...
    <div class="row">
            <div>
              <ul class="nav nav-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                      <button class="btn btn-dark bg-warning text-dark ps-3 ms-2 my-2 nav-link" id="absensi-tab" data-bs-toggle="tab" data-bs-target="#absensi" type="button" role="tab" aria-controls="absen" aria-selected="false"><h6>Absensi</h6></button>
                  </li>
                  </ul>
            </div>
                            ...
                            $("#form<?= $biodata->id_biodata ?>").on('submit',function(event){
                              event.preventDefault();
                                ...
                                var imt = document.getElementById('keterangan').value ;
                                    ...
                                    $.ajax({
                                        url : "<?= base_url('Danru/Profile/BiodataUpdate') ?>",
                                        ...
                                        success : function(response){
                                          Swal.fire({
                                            ...
                                            title : response
                                              ...
                                              window.location.href="<?= base_url("Danru/Profile") ?>"
                                            })
                                        }
                                    })
                            })
                ...
                $("#formEmployee").on('submit',function(event){
                  event.preventDefault();
                    ...
                    var areaKerja   = document.getElementById('area_kerja').value;
                          $.ajax({
                            url : "<?= base_url('Danru/Profile/EmployeeUpdate') ?>",
                            data : new FormData(this),
                            method : "POST",
                            contentType : false ,
                            processData : false ,
